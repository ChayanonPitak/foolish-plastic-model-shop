...
export default function ProductCart({name,price,order,img}: ProductProps) {
    return (
        <div className="p-7 flex space-x-4">
            <div className="object-fill w-24 h-24 ring-2 ring-black"><img src={img} /></div>
                <div>
                    <p>{name}</p>
                    <p>${price}/piece</p>
                ...
                <div><button className='w-16 h-8 bg-sky-700 hover:bg-sky-400 text-white p-1'>Delete</button></div>
